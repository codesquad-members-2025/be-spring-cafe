...
public class ArticleServiceTest {
    ...
    void find_article_by_user(){
        ...
        Article article1 = new Article(user1, "title", "content");
        Article article2 = new Article(user1, "title", "content1");
        Article article3 = new Article(user2, "title", "content1");
    ...
    void find_article_by_title(){
        User user = new User("jdragon","dino","1234","aa@aa");
        Article article1 = new Article(user, "title1", "content");
        Article article2 = new Article(user, "title1", "content");
        Article article3 = new Article(user, "title2", "content");
        articleService.saveArticle(article1);
        articleService.saveArticle(article2);
        articleService.saveArticle(article3);
