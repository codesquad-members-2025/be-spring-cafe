...
public interface ArticleRepository extends JpaRepository<Article, Long> {
    ...
    @Query("SELECT DISTINCT a FROM Article a LEFT JOIN FETCH a.writer LEFT JOIN FETCH a.replies")
    List<Article> findAllWithRepliesAndWriter();

    @Query("SELECT a FROM Article a LEFT JOIN FETCH a.writer LEFT JOIN FETCH a.replies r LEFT JOIN FETCH r.writer WHERE a.id = :id")
